...
driver.get(
    "https://cgc.gems.pro/AlumCgc/Alumni/FindAlumni_List.aspx?SiteMapTreeExpanded=cf477dd3-6fe7-4299-a66d-96a49c86ab9d&SetLanguage=en-CA")
...
try:
    AluminiList = WebDriverWait(driver, 10).until(
    ...
    for person in personNames:
        ...
        print(
            "First Name: " + FirstN.text + ", Last Name: " + LastN.text + ", Type: " + type.text + ", Sport: " + sport.text)
